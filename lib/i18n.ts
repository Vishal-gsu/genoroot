...
const en: Dict = {
  ...
  q: {
    ...
    q14: { kicker: "14 of 16", title: "Side effects" },
  ...
  q14fromProducts: "We saved these from what you used. Add more if you like.",
  q14marked: "You marked side effects. Want to tell the doctor anything?",
  q14none: "No side effects from what you listed. Still right?",
  q14ask: "Any side effects or a poor response to treatment?",
  q14optional: "Optional.",
...
const hi: Dict = {
  ...
  q: {
    ...
    q14: { kicker: "14 / 16", title: "दुष्प्रभाव" },
  ...
  wordsLeft: "शब्द बाकी",
  q14fromProducts: "जो आपने बताया, वो सेव है। चाहें तो और जोड़ें।",
  q14marked: "साइड इफ़ेक्ट चुना है। डॉक्टर को कुछ और बताना है?",
  q14none: "लिस्ट में साइड इफ़ेक्ट नहीं। यही सही है?",
  q14ask: "इलाज से कोई नुकसान या कम फ़ायदा?",
  q14optional: "ज़रूरी नहीं।",
  anythingElse: "कुछ और?",
...
const hinglish: Dict = {
  ...
  otherPlaceholder: "e.g. mesotherapy, laser cap…",
  q14fromProducts: "Jo aapne bataya, save hai. Aur add karna ho to karo.",
  q14marked: "Side effects mark kiye. Doctor ko kuch aur batana hai?",
  q14none: "List mein side effects nahi. Yehi sahi hai?",
